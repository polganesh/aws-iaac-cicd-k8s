module "vpc" {
  ...
  vpc_cidr_block          = "10.10.0.0/16" # change it
  public_subnet_cidr_list = ["10.10.1.0/24", "10.10.2.0/24", "10.10.3.0/24"] # change it
  private_app_subnet_list = ["10.10.4.0/24", "10.10.5.0/24", "10.10.6.0/24"] # change it
  private_db_subnet_list  = ["10.10.7.0/24", "10.10.8.0/24", "10.10.9.0/24"] # change it
  region                  = "eu-central-1"
  region_id               = "euc1"
  az_list                 = ["eu-central-1a", "eu-central-1b", "eu-central-1c"]
  # for creating vpc module it should be same vpc_seq_id == seq_id
  vpc_seq_id              = "001" # change it
  seq_id                  = "001" # change it
  environment             = "dev" # change it
  cost_centre             = "tech"
